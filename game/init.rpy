define kay = Character(u'凯托', what_outlines=[(3,"#000000", 1, 1),(2,"#575757", 0, 0)],who_outlines=[(5,"#000000",1,1),(3,"#575757",0,0)],ctc="ctc",ctc_position="fixed")
define asa = Character(u'阿萨嘉', what_outlines=[(3, "#000000", 1, 1),(2, "#be4c58", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#be4c58", 0, 0)],ctc="ctc",ctc_position="fixed")
define sha = Character(u'厦尔', what_outlines=[(3, "#000000", 1, 1),(2, "#26a3bc", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#26a3bc", 0, 0)],ctc="ctc",ctc_position="fixed")
define chi = Character(u'切嘉拉', what_outlines=[(3, "#000000", 1, 1),(2, "#615a9b", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#615a9b", 0, 0)],ctc="ctc",ctc_position="fixed")
define ava = Character(u'艾瓦', what_outlines=[(3, "#000000", 1, 1),(2, "#4A2A1A", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#4A2A1A", 0, 0)],ctc="ctc",ctc_position="fixed" )
define sol = Character(u'索拉', what_outlines=[(3, "#000000", 1, 1),(2, "#75798A", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#75798A", 0, 0)],ctc="ctc",ctc_position="fixed" )
define mar = Character(u'玛蕾', what_outlines=[(3, "#000000", 1, 1),(2, "#979797", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#979797", 0, 0)],ctc="ctc",ctc_position="fixed" )
define cro = Character(u'克劳', what_outlines=[(3, "#000000", 1, 1),(2, "#848484", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#848484", 0, 0) ],ctc="ctc",ctc_position="fixed"  )
define adr = Character(u'上将', what_outlines=[(3, "#000000", 1, 1),(2, "#265739", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#265739", 0, 0)],ctc="ctc",ctc_position="fixed" )
define tut = Character(u'教程', what_outlines=[(3, "#000000", 1, 1),(2, "#323232", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#323232", 0, 0)],ctc="ctc",ctc_position="fixed" )
define narrator = Character(' ', what_outlines=[(3, "#000000", 1, 1),(2, "#272727", 0, 0) ],ctc="ctc",ctc_position="fixed")
define alp = Character(u'阿尔法', what_outlines=[(3, "#000000", 1, 1),(2, "#615a9b", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#615a9b", 0, 0)],ctc="ctc",ctc_position="fixed" )
define arc = Character(u'阿卡迪乌斯', what_outlines=[(3, "#000000", 1, 1),(2, "#701d2a", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#701d2a", 0, 0)],ctc="ctc",ctc_position="fixed" )
define ali = Character(u'爱丽丝', what_outlines=[(3, "#000000", 1, 1),(2, "#701d2a", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#701d2a", 0, 0)],ctc="ctc",ctc_position="fixed" )
define jay = Character(u'奥克朗', what_outlines=[(3, "#000000", 1, 1),(2, "#615a9b", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#615a9b", 0, 0)],ctc="ctc",ctc_position="fixed")
define pro = Character(u'原型', what_outlines=[(3, "#000000", 1, 1),(2, "#615a9b", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#615a9b", 0, 0) ],ctc="ctc",ctc_position="fixed" )
define lyn = Character(u'琳', what_outlines=[(3, "#000000", 1, 1),(2, "#615a9b", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#615a9b", 0, 0) ],ctc="ctc",ctc_position="fixed" )
define cla = Character(u'科洛特', what_outlines=[(3, "#000000", 1, 1),(2, "#955393", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#e6a2c3", 0, 0) ],ctc="ctc",ctc_position="fixed" )
define fon = Character(u'方特纳', what_outlines=[(3, "#000000", 1, 1),(2, "#3B0B39", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#3B0B39", 0, 0) ],ctc="ctc",ctc_position="fixed" )
...
define cul = Character(u'库仑', what_outlines=[(3, "#000000", 1, 1),(2, "#df6a3d", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#df6a3d", 0, 0) ],ctc="ctc",ctc_position="fixed" )
define ica = Character(u'伊卡莉', what_outlines=[(3, "#000000", 1, 1),(2, "7d660c", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "dd9c38", 0, 0)],ctc="ctc",ctc_position="fixed" )
define kry = Character(u'科莉斯卡', what_outlines=[(3, "#000000", 1, 1),(2, "#3b3d66", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#3b3d66", 0, 0)],ctc="ctc",ctc_position="fixed" )
define cos = Character(u'柯赛特', what_outlines=[(3, "#000000", 1, 1),(2, "#d39980", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#d39980", 0, 0)],ctc="ctc",ctc_position="fixed" )
define pof = Character(u'PACT军官', what_outlines=[(3, "#000000", 1, 1),(2, "#d04545", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#d04545", 0, 0)],ctc="ctc",ctc_position="fixed" )
define pac = Character(u'PACT少尉', what_outlines=[(3, "#000000", 1, 1),(2, "#d04545", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#d04545", 0, 0)],ctc="ctc",ctc_position="fixed" )
define unof = Character(u'军官', what_outlines=[(3, "#000000", 1, 1),(2, "#d04545", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#d04545", 0, 0)],ctc="ctc",ctc_position="fixed" )
define cre = Character(" ", what_size=30,what_ypos=-700)
define wan = Character(u'游荡者', what_outlines=[(3, "#000000", 1, 1),(2, "#3b3d66", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#3b3d66", 0, 0)],ctc="ctc",ctc_position="fixed" )
define kuu = Character(u'库莎娜', what_outlines=[(3, "#000000", 1, 1),(2, "#d04545", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#d04545", 0, 0)],ctc="ctc",ctc_position="fixed" )
define cre1 = Character(u'舰员1', what_outlines=[(3, "#000000", 1, 1),(2, "#615a9b", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#615a9b", 0, 0)],ctc="ctc",ctc_position="fixed" )
define cre2 = Character(u'舰员2', what_outlines=[(3, "#000000", 1, 1),(2, "#615a9b", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#615a9b", 0, 0)],ctc="ctc",ctc_position="fixed" )
define cre3 = Character(u'舰员3', what_outlines=[(3, "#000000", 1, 1),(2, "#615a9b", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#615a9b", 0, 0)],ctc="ctc",ctc_position="fixed" )
define mrn = Character(u'陆战队员', what_outlines=[(3, "#000000", 1, 1),(2, "#615a9b", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#615a9b", 0, 0)],ctc="ctc",ctc_position="fixed" )
define com = Character(u'通讯', what_outlines=[(3, "#000000", 1, 1),(2, "#615a9b", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#615a9b", 0, 0)],ctc="ctc",ctc_position="fixed" )
define kayo = Character(u'过去的凯托', what_outlines=[(3,"#000000", 1, 1),(2,"#575757", 0, 0)],who_outlines=[(5,"#000000",1,1),(3,"#575757",0,0)],ctc="ctc",ctc_position="fixed")
define unp = Character(u'未知驾驶员', what_outlines=[(3, "#000000", 1, 1),(2, "#615a9b", 0, 0) ], who_outlines=[(5, "#000000", 1, 1),(3, "#615a9b", 0, 0)],ctc="ctc",ctc_position="fixed" )
init -1 python:
...
init python:
    ...
    Planet("ASTRAL EXPANSE", "Dynamic_mission", 1250, 540, "warpto_astralexpanse","Map/astralexpanse.jpg","Map/astralexpanse_info.png")
    ...
    Planet("RYUVIA PRIME", "Dynamic_mission", 1410, 740, "warpto_ryuvia","Map/ryuvia.jpg","Map/ryuvia_info.png")
    ...
    Planet("PACEMUS NEBULA", "Dynamic_mission", 1320, 570, "warpto_pacemus","Map/pacemus.jpg","Map/pacemus_info.png")
