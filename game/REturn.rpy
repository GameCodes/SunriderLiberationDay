...
label attackdronewithpistol:
    ...
    show expression Text("BAD END: GUNNED DOWN",yalign=0.5,size=90,color="a00")
    pause 3
    $dshow(34311)
...
label escapeintotunnel:
    ...
    $check_for_all_endings()
    show expression Text("BAD END: CRUSHED",yalign=0.5,size=90,color="a00")
    pause 3
    $dshow(32311)
...
label gotobackupftl:
    ...
    if girl == u"伊卡莉" :
        ...
        if trustclaude == False:
            ...
            $check_for_all_endings()
            show expression Text("BAD END: FROZEN",yalign=0.5,size=90,color="a00")
            pause 3
            $dshow(34111)
...
label badend_deathbydecompression:
    ...
    $check_for_all_endings()
    show expression Text("BAD END: EXPLOSIVE DEPRESSURIZATION",yalign=0.5,size=90,color="a00")
    pause 3
    $dshow(32310)
